...
<head>
  ...
  <style>
    /* Same styles as previous category pages */
    ...
    function displayBooks() {
      ...
      document.getElementById("bookList").innerHTML = books.map(book => `
        <div class="book-card">
          ...
          <h3>${book.title}</h3>
          <p>Rs. ${book.price}</p>
          <p class="stock-info">${book.stock > 0 ? "Only " + book.stock + " left" : "<span class='out-of-stock'>Out of Stock</span>"}</p>
